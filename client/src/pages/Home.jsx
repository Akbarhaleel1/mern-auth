...
export default function Home() {
  return (
    ...
    <div className="max-w-3xl text-center px-6">
      ...
      <button className="mt-12 bg-white text-indigo-600 font-bold py-2 px-6 rounded-full hover:bg-indigo-500 hover:text-white transition duration-300 ease-in-out">Get Started</button>
    </div>
  </div>
  );
}
